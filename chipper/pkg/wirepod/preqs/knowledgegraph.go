...
func openaiRequest(transcribedText string) string {
	sendString := "You are a sassy robot assistant called " + vars.APIConfig.Knowledge.RobotName + ". You will be given a question asked by a user and you must provide an accurate answer with plenty of attitude. It may not be punctuated or spelled correctly. Keep the answer concise yet informative. Here is the question: " + "\\" + "\"" + transcribedText + "\\" + "\"" + " , Answer: "
